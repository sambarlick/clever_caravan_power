...
BATTERY_STATE_MAP = {0: "Idle", 1: "Charging", 2: "Discharging"}
...
MPP_MODE_MAP = {0: "Off", 1: "Limited", 2: "MPPT Active", 255: "Unavailable"}

DIGITAL_INPUT_STATE_MAP = {
    0: "Low", 1: "High", 2: "Off", 3: "On", 4: "No", 5: "Yes",
    6: "Open", 7: "Closed", 8: "OK", 9: "Alarm", 10: "Running", 11: "Stopped",
}
...
SENSOR_DEFS: tuple[VSensorDef, ...] = (
    ...
    VSensorDef("battery_state", "system", "Dc/Battery/State", "Battery State",
               DEV_BATTERY, icon="mdi:battery-sync", options_map=BATTERY_STATE_MAP),
    VSensorDef("ac_in_source", "system", "Ac/ActiveIn/Source", "AC Input Source",
               DEV_GX, icon="mdi:transmission-tower", options_map=AC_IN_SOURCE_MAP,
               entity_category="diagnostic", enabled_default=False),
    VSensorDef("sys_alternator_power", "system", "Dc/Alternator/Power", "Alternator Power (System)",
               DEV_ALTERNATOR, "W", "power", "measurement", "mdi:engine",
               enabled_default=False, suggested_precision=0),
    # ------------------------------------------------------------------- vebus
    VSensorDef("vebus_out_v", "vebus", "Ac/Out/L1/V", "Inverter Output Voltage",
               DEV_GX, "V", "voltage", "measurement", entity_category="diagnostic",
               enabled_default=False, suggested_precision=1),
    VSensorDef("vebus_out_i", "vebus", "Ac/Out/L1/I", "Inverter Output Current",
               DEV_GX, "A", "current", "measurement", entity_category="diagnostic",
               enabled_default=False, suggested_precision=1),
    VSensorDef("vebus_out_f", "vebus", "Ac/Out/L1/F", "Inverter Output Frequency",
               DEV_GX, "Hz", "frequency", "measurement", entity_category="diagnostic",
               enabled_default=False, suggested_precision=1),
    VSensorDef("vebus_out_p", "vebus", "Ac/Out/L1/P", "Inverter Output Power",
               DEV_GX, "W", "power", "measurement", enabled_default=False,
               suggested_precision=0),
    VSensorDef("vebus_in_v", "vebus", "Ac/ActiveIn/L1/V", "Shore Voltage",
               DEV_GX, "V", "voltage", "measurement", "mdi:power-socket-au",
               enabled_default=False, suggested_precision=1, none_as_zero=True),
    VSensorDef("vebus_in_i", "vebus", "Ac/ActiveIn/L1/I", "Shore Current",
               DEV_GX, "A", "current", "measurement", "mdi:power-socket-au",
               enabled_default=False, suggested_precision=1, none_as_zero=True),
    VSensorDef("vebus_in_f", "vebus", "Ac/ActiveIn/L1/F", "Shore Frequency",
               DEV_GX, "Hz", "frequency", "measurement", entity_category="diagnostic",
               enabled_default=False, suggested_precision=1),
    VSensorDef("vebus_dc_current", "vebus", "Dc/0/Current", "Inverter DC Current",
               DEV_GX, "A", "current", "measurement", entity_category="diagnostic",
               enabled_default=False, suggested_precision=1),
    VSensorDef("vebus_dc_power", "vebus", "Dc/0/Power", "Inverter DC Power",
               DEV_GX, "W", "power", "measurement", entity_category="diagnostic",
               enabled_default=False, suggested_precision=0),
    VSensorDef("vebus_dc_temp", "vebus", "Dc/0/Temperature", "Inverter Temperature",
               DEV_GX, "°C", "temperature", "measurement", entity_category="diagnostic",
               enabled_default=False),
    VSensorDef("inverter_alarm_ripple", "vebus", "Alarms/Ripple", "Inverter Ripple Alarm",
               DEV_GX, icon="mdi:alert", options_map=ALARM_MAP, enabled_default=False),
    VSensorDef("inverter_alarm_hdcv", "vebus", "Alarms/HighDcVoltage",
               "Inverter High DC Voltage Alarm", DEV_GX, icon="mdi:alert",
               options_map=ALARM_MAP, enabled_default=False),
    VSensorDef("inverter_alarm_hdci", "vebus", "Alarms/HighDcCurrent",
               "Inverter High DC Current Alarm", DEV_GX, icon="mdi:alert",
               options_map=ALARM_MAP, enabled_default=False),
    # ------------------------------------------------------------ solarcharger
    VSensorDef("sc_yield_today", "solarcharger", "History/Daily/0/Yield",
               "Solar Charger {instance} Yield Today",
               DEV_SOLAR, "kWh", "energy", "total_increasing", "mdi:solar-power",
               enabled_default=False, suggested_precision=2),
    VSensorDef("sc_yield_yesterday", "solarcharger", "History/Daily/1/Yield",
               "Solar Charger {instance} Yield Yesterday",
               DEV_SOLAR, "kWh", None, None, "mdi:solar-power",
               entity_category="diagnostic", enabled_default=False,
               suggested_precision=2),
    VSensorDef("sc_max_power_today", "solarcharger", "History/Daily/0/MaxPower",
               "Solar Charger {instance} Max Power Today",
               DEV_SOLAR, "W", "power", None, "mdi:white-balance-sunny",
               entity_category="diagnostic", enabled_default=False,
               suggested_precision=0),
    VSensorDef("sc_mpp_mode", "solarcharger", "MppOperationMode",
               "Solar Charger {instance} MPPT Mode",
               DEV_SOLAR, icon="mdi:solar-power-variant", options_map=MPP_MODE_MAP,
               entity_category="diagnostic", enabled_default=False),
    VSensorDef("sc_error", "solarcharger", "ErrorCode", "Solar Charger {instance} Error Code",
               DEV_SOLAR, icon="mdi:alert-circle", entity_category="diagnostic",
               enabled_default=False),
    VSensorDef("sc_load_current", "solarcharger", "Load/I", "Solar Charger {instance} Load Current",
               DEV_SOLAR, "A", "current", "measurement", entity_category="diagnostic",
               enabled_default=False, suggested_precision=1),
    # -------------------------------------------------------------- alternator
    VSensorDef("alt_in_current", "alternator", "Dc/In/I", "Alternator {instance} Input Current",
               DEV_ALTERNATOR, "A", "current", "measurement", "mdi:current-dc",
               expire=10, enabled_default=False, suggested_precision=1),
    VSensorDef("alt_in_power", "alternator", "Dc/In/P", "Alternator {instance} Input Power",
               DEV_ALTERNATOR, "W", "power", "measurement", "mdi:engine",
               expire=10, enabled_default=False, suggested_precision=0),
    VSensorDef("alt_state", "alternator", "State", "Alternator {instance} State",
               DEV_ALTERNATOR, icon="mdi:car-battery", options_map=VEBUS_STATE_MAP,
               enabled_default=False),
    VSensorDef("alt_error", "alternator", "ErrorCode", "Alternator {instance} Error Code",
               DEV_ALTERNATOR, icon="mdi:alert-circle", entity_category="diagnostic",
               enabled_default=False),
    # ----------------------------------------------------- battery monitor svc
    VSensorDef("bm_soc", "battery", "Soc", "Battery Monitor {instance} SoC",
               DEV_BATTERY, "%", "battery", "measurement", enabled_default=False,
               suggested_precision=0),
    VSensorDef("bm_power", "battery", "Dc/0/Power", "Battery Monitor {instance} Power",
               DEV_BATTERY, "W", "power", "measurement", enabled_default=False,
               suggested_precision=0),
    VSensorDef("bm_temperature", "battery", "Dc/0/Temperature",
               "Battery Monitor {instance} Temperature",
               DEV_BATTERY, "°C", "temperature", "measurement", enabled_default=False),
    VSensorDef("bm_aux_voltage", "battery", "Dc/1/Voltage", "Starter Battery Voltage",
               DEV_BATTERY, "V", "voltage", "measurement", "mdi:car-battery",
               suggested_precision=2),
    VSensorDef("bm_capacity", "battery", "Capacity", "Battery Monitor {instance} Capacity",
               DEV_BATTERY, "Ah", None, None, "mdi:battery-high",
               entity_category="diagnostic", enabled_default=False),
    VSensorDef("bm_hist_deepest", "battery", "History/DeepestDischarge",
               "Battery Monitor {instance} Deepest Discharge",
               DEV_BATTERY, "Ah", None, None, "mdi:battery-arrow-down",
               entity_category="diagnostic", enabled_default=False,
               suggested_precision=1),
    VSensorDef("bm_hist_avg_discharge", "battery", "History/AverageDischarge",
               "Battery Monitor {instance} Average Discharge",
               DEV_BATTERY, "Ah", None, None, "mdi:battery-arrow-down-outline",
               entity_category="diagnostic", enabled_default=False,
               suggested_precision=1),
    VSensorDef("bm_hist_cycles", "battery", "History/ChargeCycles",
               "Battery Monitor {instance} Charge Cycles",
               DEV_BATTERY, None, None, "total_increasing", "mdi:battery-sync",
               entity_category="diagnostic", enabled_default=False),
    VSensorDef("bm_hist_charged", "battery", "History/ChargedEnergy",
               "Battery Monitor {instance} Charged Energy",
               DEV_BATTERY, "kWh", "energy", "total_increasing", "mdi:battery-plus",
               entity_category="diagnostic", enabled_default=False,
               suggested_precision=1),
    VSensorDef("bm_hist_discharged", "battery", "History/DischargedEnergy",
               "Battery Monitor {instance} Discharged Energy",
               DEV_BATTERY, "kWh", "energy", "total_increasing", "mdi:battery-minus",
               entity_category="diagnostic", enabled_default=False,
               suggested_precision=1),
    VSensorDef("bm_hist_full", "battery", "History/TimeSinceLastFullCharge",
               "Battery Monitor {instance} Time Since Full Charge",
               DEV_BATTERY, "s", "duration", None, "mdi:timer-sand",
               entity_category="diagnostic", enabled_default=False),
    VSensorDef("bm_hist_ah_drawn", "battery", "History/TotalAhDrawn",
               "Battery Monitor {instance} Total Ah Drawn",
               DEV_BATTERY, "Ah", None, None, "mdi:battery-charging-wireless-alert",
               entity_category="diagnostic", enabled_default=False,
               suggested_precision=0),
    # ------------------------------------------------------------------ dcload
    VSensorDef("dcload_power", "dcload", "Dc/0/Power", "DC Load {instance} Power",
               DEV_GX, "W", "power", "measurement", "mdi:lightning-bolt",
               enabled_default=False, suggested_precision=0),
    VSensorDef("dcload_current", "dcload", "Dc/0/Current", "DC Load {instance} Current",
               DEV_GX, "A", "current", "measurement", entity_category="diagnostic",
               enabled_default=False, suggested_precision=1),
    VSensorDef("dcload_voltage", "dcload", "Dc/0/Voltage", "DC Load {instance} Voltage",
               DEV_GX, "V", "voltage", "measurement", entity_category="diagnostic",
               enabled_default=False, suggested_precision=1),
    # -------------------------------------------------------------------- tank
    VSensorDef("tank_temperature", "tank", "Temperature", "Tank {instance} Temperature",
               DEV_TANKS, "°C", "temperature", "measurement", enabled_default=False,
               custom_name="{custom} Temperature"),
    VSensorDef("tank_battery", "tank", "BatteryVoltage", "Tank {instance} Sender Battery",
               DEV_TANKS, "V", "voltage", "measurement", entity_category="diagnostic",
               enabled_default=False, custom_name="{custom} Sender Battery"),
    # ------------------------------------------------------------- temperature
    VSensorDef("temp_pressure", "temperature", "Pressure", "Pressure {instance}",
               DEV_GX, "hPa", "atmospheric_pressure", "measurement",
               enabled_default=False, custom_name="{custom} Pressure"),
    VSensorDef("temp_battery", "temperature", "BatteryVoltage", "Sensor {instance} Battery",
               DEV_GX, "V", "voltage", "measurement", entity_category="diagnostic",
               enabled_default=False, custom_name="{custom} Sensor Battery"),
    # --------------------------------------------------------------------- gps
    VSensorDef("gps_lat", "gps", "Position/Latitude", "GX GPS Latitude",
               DEV_GX, "°", None, None, "mdi:latitude",
               entity_category="diagnostic", enabled_default=False,
               suggested_precision=5),
    VSensorDef("gps_lon", "gps", "Position/Longitude", "GX GPS Longitude",
               DEV_GX, "°", None, None, "mdi:longitude",
               entity_category="diagnostic", enabled_default=False,
               suggested_precision=5),
    VSensorDef("gps_speed", "gps", "Speed", "GX GPS Speed",
               DEV_GX, "m/s", "speed", "measurement", "mdi:speedometer",
               enabled_default=False, suggested_precision=1),
    VSensorDef("gps_course", "gps", "Course", "GX GPS Course",
               DEV_GX, "°", None, "measurement", "mdi:compass",
               entity_category="diagnostic", enabled_default=False,
               suggested_precision=0),
    VSensorDef("gps_altitude", "gps", "Altitude", "GX GPS Altitude",
               DEV_GX, "m", "distance", "measurement", "mdi:elevation-rise",
               entity_category="diagnostic", enabled_default=False,
               suggested_precision=0),
    VSensorDef("gps_satellites", "gps", "NrOfSatellites", "GX GPS Satellites",
               DEV_GX, None, None, "measurement", "mdi:satellite-variant",
               entity_category="diagnostic", enabled_default=False),
    VSensorDef("gps_fix", "gps", "Fix", "GX GPS Fix",
               DEV_GX, icon="mdi:crosshairs-gps", options_map=GPS_FIX_MAP,
               entity_category="diagnostic", enabled_default=False),
    # ------------------------------------------------------------ digitalinput
    VSensorDef("digin_state", "digitalinput", "State", "Digital Input {instance}",
               DEV_GX, icon="mdi:electric-switch", options_map=DIGITAL_INPUT_STATE_MAP,
               enabled_default=False, custom_name="{custom}"),
)
...
BINARY_SENSOR_DEFS: tuple[VBinarySensorDef, ...] = (
    ...
    VBinarySensorDef("inverter_inverting", "vebus", "State",
                     ...
                     enabled_default=False),
    # ===================================================== v0.1.7 parity pass
    VBinarySensorDef("bm_alarm_low_voltage", "battery", "Alarms/LowVoltage",
                     "Battery {instance} Low Voltage Alarm", "gt:0", DEV_BATTERY,
                     "problem", enabled_default=False),
    VBinarySensorDef("bm_alarm_high_voltage", "battery", "Alarms/HighVoltage",
                     "Battery {instance} High Voltage Alarm", "gt:0", DEV_BATTERY,
                     "problem", enabled_default=False),
    VBinarySensorDef("bm_alarm_low_soc", "battery", "Alarms/LowSoc",
                     "Battery {instance} Low SoC Alarm", "gt:0", DEV_BATTERY,
                     "problem", enabled_default=False),
    VBinarySensorDef("bm_alarm_low_cell", "battery", "Alarms/LowCellVoltage",
                     "Battery {instance} Low Cell Voltage Alarm", "gt:0", DEV_BATTERY,
                     "problem", enabled_default=False),
    VBinarySensorDef("bm_alarm_imbalance", "battery", "Alarms/CellImbalance",
                     "Battery {instance} Cell Imbalance Alarm", "gt:0", DEV_BATTERY,
                     "problem", enabled_default=False),
    VBinarySensorDef("bm_alarm_internal", "battery", "Alarms/InternalFailure",
                     "Battery {instance} Internal Failure Alarm", "gt:0", DEV_BATTERY,
                     "problem", enabled_default=False),
    VBinarySensorDef("digin_alarm", "digitalinput", "Alarm",
                     "Digital Input {instance} Alarm", "gt:0", DEV_GX,
                     "problem", enabled_default=False),
)
...
NUMBER_DEFS: tuple[VNumberDef, ...] = (
    ...
    VNumberDef("alt_charge_limit", "alternator", "Settings/ChargeCurrentLimit",
               "Alternator {instance} Charge Limit", "A", DEV_ALTERNATOR,
               "mdi:current-dc", step=1.0, min=0.0, max=100.0),
)
