...
SENSOR_DEFS: tuple[VSensorDef, ...] = (
    ...
    VSensorDef("vebus_in_v", "vebus", "Ac/ActiveIn/L1/V", "Shore Voltage",
               ...
               suggested_precision=1, none_as_zero=True),
)
